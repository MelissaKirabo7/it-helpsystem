...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ServeDesk — IT Ticketing System" },
      {
        name: "description",
        content:
          "Log IT complaints from any workstation, triage them in the technician queue and archive resolved tickets automatically.",
      },
